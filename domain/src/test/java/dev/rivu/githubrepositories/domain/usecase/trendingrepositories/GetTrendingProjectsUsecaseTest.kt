...
class GetTrendingProjectsUsecaseTest {
    private lateinit var trendingProjectsUsecase: GetTrendingProjectsUsecase
    private lateinit var schedulerProvider: SchedulerProvider
    private lateinit var mockTrendingProjectRepository: TrendingProjectRepository

    private lateinit var usecaseParam: GetTrendingProjectsUsecase.Params

    @Before
    fun setup() {
        usecaseParam = GetTrendingProjectsUsecase.Params()
        schedulerProvider = FakeSchedulerProvider
        mockTrendingProjectRepository = mock()

        trendingProjectsUsecase = GetTrendingProjectsUsecase(
